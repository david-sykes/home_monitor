##Note this is a copy of the Python library https://github.com/pimoroni/sgp30-python
## I had difficulty installing so just creaetd a local module
...
class SGP30Reading:
    ...
    def __str__(self):
        return """{}|{}|{}""".format(datetime.now().strftime('%d%m%Y %H:%M:%S'),
                                                            self.equivalent_co2,
                                                            self.total_voc)
